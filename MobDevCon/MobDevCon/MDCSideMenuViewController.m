...
@interface MDCSideMenuViewController ()
...
@implementation MDCSideMenuViewController
...
- (id)initWithMenuViewController:(UIViewController *)menuViewController mainViewController:(MDCMainViewController *)mainViewController
{
...
- (void)commonInitialization
{
    ...
    self.animationType = MDCSideMenuAnimationTypeSlideOver;
...
- (CGAffineTransform)openTransformForView:(UIView *)view
{
    ...
    //*MAS MODIFY
    CGAffineTransform newTransform = CGAffineTransformTranslate(view.transform, 100 + self.edgeOffset.horizontal, self.edgeOffset.vertical);
...
- (void)setMainViewController:(MDCMainViewController *)mainViewController animated:(BOOL)animated closeMenu:(BOOL)closeMenu
{
    ...
    switch (self.animationType) {
        case MDCSideMenuAnimationTypeSlideOver: {
        ...
        case MDCSideMenuAnimationTypeFadeIn:
...
@implementation UIViewController (MDCSideMenuViewController)

- (void)setSideMenuViewController:(MDCSideMenuViewController *)sideMenuViewController
{
    objc_setAssociatedObject(self, @selector(sideMenuViewController), sideMenuViewController, OBJC_ASSOCIATION_ASSIGN);
}

- (MDCSideMenuViewController *)sideMenuViewController
{
    MDCSideMenuViewController *sideMenuController = objc_getAssociatedObject(self, @selector(sideMenuViewController));
